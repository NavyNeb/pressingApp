                        ...
                        <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'flex-start',  }} >
                            ...
                            <View style={{ width: width - 75, paddingHorizontal: 10 }}>
                                <View style = {{ display: 'flex', flexDirection:'row', alignItems: 'center', justifyContent: 'space-between' }} >
                                    <View>
                                        <Text style = {{ color: 'dodgerblue', fontSize: 16 }} >Delivered</Text>
                                        <Text style = {{ color: '#000', fontSize: 12.4 }} >Order No.23122020</Text>
                                    </View>
                                    <TouchableOpacity activeOpacity = {1} style = {{ height: 45, width: 110, backgroundColor: '#f1f1f5', justifyContent: 'center', alignItems: 'center', borderRadius: 9 }} >
                                        <Text style = {{ color: 'lightgray', fontSize: 13 }} >Delivered</Text>
                                    </TouchableOpacity>
                                </View>
