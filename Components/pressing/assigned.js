...
function Assigned({ naviagtion, Order }){
    ...
    return (
        <View style = {{ width, flex: 1, backgroundColor: '#f1f1f5', paddingTop: 35 }} >
            <ScrollView style = {{ width, paddingHorizontal: 6, marginTop: 10, }} >
                <View style = {{ height: height / 3.4, backgroundColor: '#fff', borderRadius: 8, elevation: 3, paddingHorizontal: 10, paddingVertical: 20, marginBottom: 7 }} >
...
export default connect(mapStateToProps, undefined)(Assigned)